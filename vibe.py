...
FUTURE_PROMPT = """Напиши короткий пост-размышление для Telegram-канала про ИИ: куда движется искусственный интеллект и каким может быть наше будущее. Возьми одну ясную мысль или наблюдение, а не обзор всего сразу. Живо, умно, с лёгким личным взглядом, без хайпа, без апокалиптических клише и без банальностей. По-русски, 500–1100 символов. Голос увлечённого эксперта, который думает вслух. Не выдумывай конкретных фактов, цифр и цитат. Формат — HTML для Telegram (только <b>, <i>), без заголовков-ярлыков и без эмодзи-перегруза."""
